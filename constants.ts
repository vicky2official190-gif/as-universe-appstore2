...
export const DATA_VERSION = 'v1769789660587';
...
export const APP_DATA: AppItem[] = [
  ...
  },
  {
    ...
    "links": [
      {
        "label": "GEOGRAPHY || SSC GK 4.0",
        "url": "https://youtube.com/playlist?list=PLVdEbxG29AsZ_S324ofY1v3HcuPI5CFPK&si=AZXystFFVIzXv5P9"
      },
      {
        "label": "POLITY || SSC GK 4.0",
        "url": "https://youtube.com/playlist?list=PLVdEbxG29AsYDikJT-PLrcL4FthrvH1Bh&si=VNcDlu7HQE9S_bjg"
      },
      {
        "label": "ANCIENT HISTORY || SSC GK 4.0",
        "url": "https://youtube.com/playlist?list=PLVdEbxG29AsZMn9UtxphyVp2jVjOSp1g9&si=6iRaGm9XMluzvW2R"
      },
      {
        "label": "MEDIEVAL HISTORY || SSC GK 4.0",
        "url": "https://youtube.com/playlist?list=PLVdEbxG29AsZQgfLwZrseSnoUsWyT0Koz&si=9G3D5NL7n3d2GC7J"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "isNew": true,
    "iconColor": "bg-green-600",
    "downloadUrl": "https://github.com/vicky2official190-gif/selectio-way/releases/download/v1.0/selection-way.apk",
    "logoUrl": "",
    "iconUrl": "https://res.cloudinary.com/dbet2jfqo/image/upload/v1769679024/selection_way_b8tw5n.png",
    "buttonText": "Download APK",
    "rating": "4.5",
  ...
  },
  {
    "name": "APNI KAKSHA",
    "shortName": "AK",
    "description": "🎓 Apni kaksha — MOD APK \n\nCLASS 11th , 12th cource added✅\n\n👉premium ui ux \n👉no error \n👉no ads\nVideo + PDF + dpp and other available\n100% free mod ",
    "version": "V1.0",
    "downloads": "0",
    "size": "",
    "category": "Downloadable",
    "isNew": true,
    "iconColor": "bg-green-600",
    "downloadUrl": "https://github.com/vicky2official190-gif/Apni-kaksha/releases/download/v1.0/Apni.kaksha.MOD.apk",
    "logoUrl": "",
